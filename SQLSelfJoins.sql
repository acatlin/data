/*
 ...
 To consider:
   * How many levels deep is it possible to “nest” data?
   * Can you think of other “use cases” for organizing data hierarchically?
   * Are there other choices besides SQL Server for modeling hierarchical data?
